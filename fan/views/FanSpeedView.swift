...
struct FanSpeedView: View {
    ...
    @State private var needsApply: Bool = false
                ...
                VStack(spacing: 10) {
                    ...
                    Slider(
                        ...
                        onEditingChanged: { editing in
                            if !editing && Int(localSpeed) != viewModel.manualSpeed {
                                needsApply = true
                            }
                        }
                    )
                    ...
                    HStack {
                        ...
                        HStack(spacing: 4) {
                            ...
                            Text("Target: \(Int(localSpeed)) RPM")
                                ...
                                .foregroundColor(needsApply ? .orange : .secondary)
                        }
